...
const authSlice = createSlice({
    ...
    reducers: {
        ...
        removeFavorite: (state, action) => {
            ...
            if (state.user) {
                state.user.favorites = state.user.favorites.filter((favorite) => favorite !== action.payload);
            }
        }
    }
});

export const { login, logoutUser, updateUser, addFavorite, removeFavorite } = authSlice.actions;
